  ...
  return (
    <div>
        <div className={styles.container}>
            <Image src={logo} alt="cobra logo" width={100} className={styles.logo}/>
            ...
            <Image src={coaches} alt="coaches" className={styles.img}/>
